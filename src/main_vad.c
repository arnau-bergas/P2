...
int main(int argc, char *argv[]) {
  ...
  float alpha1, alpha2, zcr_stv, zcr_vts;
  int min_silence, min_voice, init_counter;
  ...
  init_counter = atoi(args.init_counter);
  ...
  vad_data = vad_open(sf_info.samplerate, alpha1, alpha2, min_silence, min_voice,  zcr_stv, zcr_vts, init_counter);
